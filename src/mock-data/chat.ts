...
export const MockChats: ChatModel[] = [
	{
		...
		messages: [
			...
			{
				dateTime: new Date('2025-02-25T10:10:00'),
				from: { login: 'ivanivanov', avatar_url: 'avatar_url_ivan' },
				to: { login: 'andrey123', avatar_url: 'avatar_url_andrey' },
				message: 'Тоже хорошо!',
			},
			{
				dateTime: new Date('2025-02-25T10:15:00'),
				from: { login: 'andrey123', avatar_url: 'avatar_url_andrey' },
				to: { login: 'ivanivanov', avatar_url: 'avatar_url_ivan' },
				message: 'Чем занимаешься?',
			},
			{
				dateTime: new Date('2025-02-25T10:20:00'),
				from: { login: 'ivanivanov', avatar_url: 'avatar_url_ivan' },
				to: { login: 'andrey123', avatar_url: 'avatar_url_andrey' },
				message: 'Работаю над новым проектом',
			},
		],
	},
	{
		...
		messages: [
			...
			{
				dateTime: new Date('2025-02-26T10:00:00'),
				from: { login: 'ivanivanov', avatar_url: 'avatar_url_ivan' },
				to: { login: 'admin', avatar_url: 'avatar_url_admin' },
				message: 'Окей, будет сделано!',
			},
		],
	},
	{
		...
		messages: [
			...
			{
				dateTime: new Date('2025-02-27T16:00:00'),
				from: { login: 'ivanivanov', avatar_url: 'avatar_url_ivan' },
				to: { login: 'alex_smith', avatar_url: 'avatar_url_alex' },
				message: 'Давай завтра в 10:00?',
			},
			{
				dateTime: new Date('2025-02-27T16:10:00'),
				from: { login: 'alex_smith', avatar_url: 'avatar_url_alex' },
				to: { login: 'ivanivanov', avatar_url: 'avatar_url_ivan' },
